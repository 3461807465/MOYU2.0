...
local Window = Library:new("MO大屁眼子版 fa")

local creds = Window:Tab("当前公告",'\49\54\48\54\48\51\51\51\52\52\56')
...
about:Label("作者 MO")
about:Label("作者qq 3461807465")
about:Label("大屁眼子")
about:Button("复制作者QQ", function()
  setclipboard("3461807465")
end)
about:Button("复制QQ群", function()
  setclipboard("155583711")
end)
...
UOG:Button("大屁眼子巴掌模拟", function()
  loadstring(game:HttpGet("https://pastebin.com/raw/iM89xGLG"))()
end)

GORG:Button("大屁眼子合并滴管", function()
  loadstring(game:HttpGet("https://pastebin.com/raw/uEa57kC3"))()
end)
