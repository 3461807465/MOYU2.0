...
ImageLabel.Size = UDim2.new(0.3, 0, 0.3, 0) -- 全屏大小
ImageLabel.BackgroundTransparency = 0 -- 不透明背景
ImageLabel.Image = "rbxassetid://112666167201442" -- 替换为实际的图片资源ID
...
ImageButton.Image = "rbxassetid://118661108749904" 
...
local win = UILib:Window("神青选择服务器",Color3.fromRGB(0, 150, 150), Enum.KeyCode.RightControl)

local tab = win:Tab("俄亥俄州")
tab:Button("神青俄亥俄州脚本", function()
loadstring(game:HttpGet(('https://raw.githubusercontent.com/gycgchgyfytdttr/shenqin/refs/heads/main/%E4%BF%84%E4%BA%A5%E4%BF%84%E5%B7%9E.lua')))()
end)
